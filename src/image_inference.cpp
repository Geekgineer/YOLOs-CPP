 ...
 * @brief Object detection in a static image using YOLO models (v5, v7, v8, v9,
 * v10, v11, v12).
 *
...
int main() {
  ...
  // const std::string imagePath = "../data/desk.jpg";        // Another
  // alternate image
  ...
  // const std::string modelPath = "../quantized_models/yolo10n_uint8.onnx"; //
  // Quantized YOLOv10 const std::string modelPath = "../models/yolo11n.onnx";
  // // YOLOv11
  ...
  // YOLO5Detector detector(modelPath, labelsPath, isGPU);  // Uncomment for
  // YOLOv5 YOLO8Detector detector(modelPath, labelsPath, isGPU);  // Uncomment
  // for YOLOv8 YOLO9Detector detector(modelPath, labelsPath, isGPU); //
  // Uncomment for YOLOv9 YOLO10Detector detector(modelPath, labelsPath, isGPU);
  // // Uncomment for YOLOv10 YOLO11Detector detector(modelPath, labelsPath,
  // isGPU); // Uncomment for YOLOv11
  YOLO12Detector detector(modelPath, labelsPath,
                          isGPU);  // Uncomment for YOLOv12
