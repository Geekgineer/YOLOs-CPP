...
# Class yolos::det::YOLOv7Detector



[**ClassList**](annotated.md) **>** [**yolos**](namespaceyolos.md) **>** [**det**](namespaceyolos_1_1det.md) **>** [**YOLOv7Detector**](classyolos_1_1det_1_1YOLOv7Detector.md)



_YOLOv7 detector (forces V7 postprocessing)_ 
...
| Type | Name |
| ---: | :--- |
|   | [**YOLOv7Detector**](#function-yolov7detector) (const std::string & modelPath, const std::string & labelsPath, bool useGPU=false) <br> |
...
### function YOLOv7Detector 

```C++
inline yolos::det::YOLOv7Detector::YOLOv7Detector (
