...
# Class yolos::det::YOLONASDetector



[**ClassList**](annotated.md) **>** [**yolos**](namespaceyolos.md) **>** [**det**](namespaceyolos_1_1det.md) **>** [**YOLONASDetector**](classyolos_1_1det_1_1YOLONASDetector.md)



_YOLO-NAS detector (forces NAS postprocessing)_ 
...
| Type | Name |
| ---: | :--- |
|   | [**YOLONASDetector**](#function-yolonasdetector) (const std::string & modelPath, const std::string & labelsPath, bool useGPU=false) <br> |
...
### function YOLONASDetector 

```C++
inline yolos::det::YOLONASDetector::YOLONASDetector (
