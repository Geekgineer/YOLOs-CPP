...
if __name__ == "__main__":
    ...
    onnx_model_path = '../models/yolo11l.onnx'   # Change this to your desired model

    # Specify the output path for the quantized model
    quantized_model_path = 'yolo11l_quantized.onnx'  # Change this to your desired output file name
