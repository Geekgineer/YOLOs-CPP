...
# Download test models for OBB (Oriented Bounding Box)
# Downloads pre-trained YOLO OBB models
...
models = ['yolov8n-obb.pt', 'yolo11n-obb.pt', 'yolo26n-obb.pt']
