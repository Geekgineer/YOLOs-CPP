...
def main(is_use_gpu = False, is_mac = False):
    ...
    print(f"Exporting OBB models to {device_arg} ...")
    ...
    for model_name in tqdm(models_to_export, desc="Exporting OBB models to ONNX"):
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        print("Usage: python export_onnx_yolo_obb.py <device>")
