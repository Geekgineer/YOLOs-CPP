...
# Download test models for pose estimation
# Downloads pre-trained YOLO pose models
...
models = ['yolov8n-pose.pt', 'yolo11n-pose.pt', 'yolo26n-pose.pt']
