...
// ===================================
//
// This header defines the YOLO11Detector class for performing object detection
// using the YOLOv11 model. It includes necessary libraries, utility structures,
 ...
 * @brief Header file for the YOLO11Detector class, responsible for object
 * detection using the YOLOv11 model with optimized performance for minimal
 * latency.
 */
...
/**
 * @brief YOLO11Detector class handles loading the YOLO model, preprocessing
