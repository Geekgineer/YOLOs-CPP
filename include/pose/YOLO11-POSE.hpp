...
// ===================================
//
// This header defines the YOLO11PoseDetector class for performing human pose
// estimation using the YOLOv11 model. It includes necessary libraries, utility
 ...
 * @brief Header file for the YOLO11PoseDetector class, responsible for human
 * pose estimation using the YOLOv11 model with optimized performance for
...
/**
 * @brief YOLO11POSEDetector class handles loading the YOLO model, preprocessing
 ...
 */
void YOLO11POSEDetector::drawBoundingBox(
...
std::vector<Detection> YOLO11POSEDetector::detect(const cv::Mat &image,
                                                  float confThreshold,
                                                  float iouThreshold) {
