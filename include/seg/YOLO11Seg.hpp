...
// ====================================================
//
// This header defines the YOLOv11SegDetector class for performing object
// detection and segmentation using the YOLOv11 model. It includes necessary
...
inline cv::Mat YOLOv11SegDetector::preprocess(
...
inline std::vector<Segmentation> YOLOv11SegDetector::segment(
