...
// ===================================
//
// This header defines the YOLO11-OBB-Detector class for performing object
// detection using the YOLOv11-OBB model. It includes necessary libraries,
 ...
 * @brief Header file for the YOLO11OBBDetector class, responsible for object
 * detection using the YOLOv11 OBB model with optimized performance for minimal
 * latency.
 */
...
/**
 * @brief YOLO11-OBB-Detector class handles loading the YOLO model,
...
std::vector<Detection> YOLO11OBBDetector::detect(const cv::Mat &image,
                                                 float confThreshold,
                                                 float iouThreshold) {
